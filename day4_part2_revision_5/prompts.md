# Prompt 1 - HTTP Request from Livebook
```elixir
system_m1 = "You are a prominent competitive programmer"
example_user_m1 = 
~S{
Q:
"""
...
"""
I: Please, write me a go program that solves this and read the input from "input.txt", also do not add comments to the code.
}

example_assistant_m1 = ~S'
package main
...
messages = [
  ...
  %{
    ...
    "content" => example_user_m1
  },
  %{
    "role" => "system name=example_assistant",
    "content" => example_assistant_m1
  },
	%{
		"role" => "user",
		"content" => user_m1
